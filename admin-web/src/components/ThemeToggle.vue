...
// View Transitions API 圆形扩散（参考 web 的 theme.vue）
...
<template>
  <button
    type="button"
    class="flex items-center justify-center w-9 h-9 rounded-full text-on-surface hover:bg-surface-container-high transition-colors"
